...
testPredict = do
  ...
  let in0 = [(1, Nothing), (2, Nothing), (3, Nothing), (5, Nothing), (8, Nothing)]
      rs0 = [2, 4, 6, 10, 16]
  ...
  -- switch once
  let in1 = [(1, Nothing), (2, Just 3), (5, Nothing), (8, Nothing), (16, Nothing)]
      rs1 = [2, 3, 15, 24, 48]
  rs1' <- embed predict' in1
  rs1' @?= rs1

  -- switch twice
  let in2 = [(1, Nothing), (2, Just 3), (5, Nothing), (8, Just 16), (2, Nothing)]
      rs2 = [2, 3, 15, 16, 32]
